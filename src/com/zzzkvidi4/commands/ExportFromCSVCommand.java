...
public class ExportFromCSVCommand extends Command {
    ...
    public void execute() {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO user (id_user, name, surname, login, email) VALUES (?, ?, ?,?, ?);")){
            ...
            System.out.println("Распознано строк - " + recognized + ", не распознано - " + notRecognized + ".");
        }
